...
class UpdateTbGatilhosTemplatesTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('tb_gatilhos_templates', function (Blueprint $table) {
            $table->string('gatilho')->change();
            $table->integer('id_tipo_projeto')->nullable()->change();
            $table->integer('dias_limite_padrao')->nullable()->change();
            ...
            $table->enum('tipo_gatilho', ['Cliente', 'Equipe'])->change();
    ...
    public function down()
    {
        Schema::table('tb_gatilhos_templates', function (Blueprint $table) {
            ...
            $table->integer('dias_limite_padrao')->nullable(false)->change();
