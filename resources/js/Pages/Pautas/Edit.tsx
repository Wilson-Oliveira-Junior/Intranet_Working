...
const PautasEdit = () => {
    const { pauta, clientes, usuarios } = usePage().props;
    ...
    const [selectedUsuarios, setSelectedUsuarios] = useState(data.idusuariocompartilhado);
    const [showModal, setShowModal] = useState(false);

    useEffect(() => {
        setShowDateField(data.urgencia === 'data_estipulada' || data.urgencia === 'cronograma');
    }, [data.urgencia]);
    ...
    return (
        <AuthenticatedLayout>
            <div className="pautas-container">
                <h1 className="pauta-title">Editar Pauta</h1>
