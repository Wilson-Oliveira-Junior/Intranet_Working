        ...
        const handleContactChange = (index: number, e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
            ...
            const handleCheckboxChange = (index: number, e: React.ChangeEvent<HTMLInputElement>) => {
                const handleCheckboxChange = (index, e) => {
                    ...
                    const newContacts = [...contacts];
                    (newContacts[index] as any).perfilcliente = [...((newContacts[index] as any).perfilcliente || []), name];
                    newContacts[index].perfilcliente = [...(newContacts[index].perfilcliente || []), name];
                    (newContacts[index] as any).perfilcliente = ((newContacts[index] as any).perfilcliente || []).filter((item: any) => item !== name);
                    newContacts[index].perfilcliente = (newContacts[index].perfilcliente || []).filter(item => item !== name);
                }
                setContacts(newContacts);
                setData('contacts', newContacts);
            };
            ...
            for (const contact of contacts) {
                if (!contact.nome_cliente || !contact.cargo_cliente || !contact.tipo_contato || !contact.telefone_cliente || !contact.email) {
                    if (!(contact as any).nome_cliente || !(contact as any).cargo_cliente || !(contact as any).tipo_contato || !(contact as any).telefone_cliente || !(contact as any).email) {
                        if (!contact.nome_cliente || !contact.cargo_cliente || !contact.tipo_contato || !contact.telefone_cliente || !contact.email) {
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-group col-sm-4 form-ficha-comercial nome-cliente">
                                        ...
                                        <div className="input-group input-group-alternative mb-3">
                                            <input
                                                ...
                                                type="text"
                                                maxLength="100"
                                                value={(contact as any).nome_cliente || ''}
                                    ...
                                    <div className="form-group col-sm-4 form-ficha-comercial cargo-cliente">
                                        ...
                                        <div className="input-group input-group-alternative mb-3">
                                            <input
                                                ...
                                                type="text"
                                                maxLength="100"
                                                value={(contact as any).cargo_cliente || ''}
                                    ...
                                    <div className="form-group col-sm-4 form-ficha-comercial responsavel-cliente">
                                        ...
                                        <div className="input-group input-group-alternative mb-3" style={{ boxShadow: 'none !important' }}>
                                            <select
                                                className="form-control"
                                                value={(contact as any).tipo_contato || ''}
                                    ...
                                    <div className="form-group col-sm-4 form-ficha-comercial telefone-cliente">
                                        ...
                                        <div className="input-group input-group-alternative mb-3">
                                            <input
                                                ...
                                                value={(contact as any).telefone_cliente || ''}
                                    ...
                                    <div className="form-group col-sm-4 form-ficha-comercial nascimento-cliente">
                                        ...
                                        <div className="input-group input-group-alternative mb-3">
                                            <input
                                                ...
                                                className="form-control"
                                                name="nascimento"
                                                value={(contact as any).nascimento || ''}
                                        ...
                                        <div className="input-group input-group-alternative mb-3">
                                            <div className="checkbox-group">
                                                <label>
                                                    <input
                                                        type="checkbox"
                                                        checked={(contact as any).perfilcliente?.includes('Conhecimento básico') || false}
                                                ...
                                                <label>
                                                    <input
                                                        type="checkbox"
                                                        checked={(contact as any).perfilcliente?.includes('Conhecimento Intermediário') || false}
                                                ...
                                                <label>
                                                    <input
                                                        type="checkbox"
                                                        checked={(contact as any).perfilcliente?.includes('Conhecimento Avançado') || false}
                                                ...
                                                <label>
                                                    <input
                                                        type="checkbox"
                                                        checked={(contact as any).perfilcliente?.includes('Exigente') || false}
                                                ...
                                                <label>
                                                    <input
                                                        type="checkbox"
                                                        checked={(contact as any).perfilcliente?.includes('Pró Ativo') || false}
                                                ...
                                                <label>
                                                    <input
                                                        type="checkbox"
                                                        checked={(contact as any).perfilcliente?.includes('Indeciso/Confuso') || false}
                                                ...
                                                <label>
                                                    <input
                                                        type="checkbox"
                                                        checked={(contact as any).perfilcliente?.includes('Aberto a novas Ideias') || false}
                                            ...
                                            <div className="form-group col-sm-12 form-ficha-comercial tipo-projeto" style={{ width: '98%' }}>
                                                ...
                                                <div className="input-group input-group-alternative mb-3" style={{ boxShadow: 'none', border: '1px solid #e1e1e1', borderRadius: '3px', padding: '3px', fontSize: '14px' }}>
                                                    <select
                                                        ...
                                                        {data.tipo_projetos && data.tipo_projetos.map((projeto: any) => (
                                                            {
                                                                data.tipo_projetos && data.tipo_projetos.map((projeto: any) => (
                                                                    {
