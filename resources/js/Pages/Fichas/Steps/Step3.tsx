                ...
                <div className="cloned-projeto-principal">
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            ...
                            <div className="form-group form-ficha-comercial data-fechamento-contrato">
                            ...
                            {/* Tipo de Manutenção */}
                            <div className="form-group form-ficha-comercial tipo_manutencao">
                            ...
                            {/* Conteúdo */}
                            <div className="form-group form-ficha-comercial conteudo_site">
                            ...
                            {/* SSL/CDN */}
                            <div className="form-group form-ficha-comercial ssl-cdn">
                            ...
                            {/* Itens de Menu */}
                            <div className="form-group form-ficha-comercial itens_menu">
                        ...
                        <div className="col-md-4">
                            {/* Prazo */}
                            <div className="form-group form-ficha-comercial prazo_projeto">
                            ...
                            {/* Idiomas */}
                            <div className="form-group form-ficha-comercial idiomas">
                            ...
                            <div className="form-group form-ficha-comercial itens_pp">
